...
class Game
    ...
    def play
        ...
        while @board.empty_positions?
            ...
            puts "#{@current_player_name}'s(#{@current_player.mark_value.to_s}) turn. please, Enter a number between 1 -- 9 :"
            ...
            if @board.win?(@current_player.mark_value)
                ...
                @board.printing
                puts 'Game Over'
                puts @current_player_name+" (#{@current_player.mark_value.to_s})" +' HAS WON!'
                return
            else
                switch_turn
                clearing_screen
